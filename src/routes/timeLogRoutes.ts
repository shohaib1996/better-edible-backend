...
router.get('/', validate({ query: dateRangeQuery }), getAllTimeLogs /* #swagger.tags = ['Time Logs'] */);
router.get('/summary', validate({ query: dateRangeQuery }), getTimeLogsSummary /* #swagger.tags = ['Time Logs'] */);
...
router.get('/:id', validate({ params: idParam }), getTimeLogById /* #swagger.tags = ['Time Logs'] */);
