...
router.put("/:id", validate({ params: idParam, body: updateCaseSchema }), updateCase /* #swagger.tags = ['Cases'] */);
router.put("/:id/status", validate({ params: idParam, body: updateCaseStatusSchema }), updateCaseStatus /* #swagger.tags = ['Cases'] */);
