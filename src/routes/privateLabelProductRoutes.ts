...
router.get("/:id", validate({ params: idParam }), getProductById /* #swagger.tags = ['Private Label Products'] */);

// POST /api/private-label-products - Create new product
router.post("/", validate({ body: createPrivateLabelProductSchema }), createProduct /* #swagger.tags = ['Private Label Products'] */);

// PUT /api/private-label-products/:id - Update product
router.put("/:id", validate({ params: idParam, body: updatePrivateLabelProductSchema }), updateProduct /* #swagger.tags = ['Private Label Products'] */);

// DELETE /api/private-label-products/:id - Delete product
router.delete("/:id", validate({ params: idParam }), deleteProduct /* #swagger.tags = ['Private Label Products'] */);

// PUT /api/private-label-products/:id/toggle - Toggle active status
router.put("/:id/toggle", validate({ params: idParam }), toggleProductStatus /* #swagger.tags = ['Private Label Products'] */);
