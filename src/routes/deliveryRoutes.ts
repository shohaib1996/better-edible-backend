...
router.put('/:id/status', validate({ params: idParam, body: updateDeliveryStatusSchema }), updateDeliveryStatus /* #swagger.tags = ['Deliveries'] */);
router.delete('/:id', validate({ params: idParam }), deleteDelivery /* #swagger.tags = ['Deliveries'] */);
